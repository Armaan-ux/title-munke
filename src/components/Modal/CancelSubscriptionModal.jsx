      ...
      >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-4">
            {fromAdvancedSettings
              ? `If you continue, your agent account will be unlinked from Michael Brown. Any broker-specific permissions, pricing, or access may be revoked.`
          ...
          <DialogFooter className="flex justify-between gap-2">
            ...
            <Button
              ...
              onClick={() => {
                fromAdvancedSettings ? onClose() : onHelpUsImprove();
                onClose();
              }}
            >
              Yes, Cancel
