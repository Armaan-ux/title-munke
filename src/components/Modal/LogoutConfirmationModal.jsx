    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-[#fffaf3] border-none shadow-2xl rounded-2xl p-8">
        <DialogHeader className="space-y-4 text-center">
          ...
          <DialogTitle className="text-2xl font-bold text-[#3b1f12]">Ready to leave?</DialogTitle>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-3 mt-8 sm:justify-center">
          <Button
            ...
            className="w-full sm:w-auto border-2 border-[#e6d6c3] text-[#7a5a49] hover:bg-[#fdf3e7] py-6 px-10 rounded-xl font-bold transition-all"
          >
            Cancel
          </Button>
          <Button
            onClick={onConfirm}
            className="w-full sm:w-auto bg-[#3b1f12] hover:bg-[#5c2f1b] text-white py-6 px-10 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
          >
            Yes, Logout
          </Button>
        </DialogFooter>
