...
const PricingDetailsHeader = ({ isPending, product }) => {
  ...
  return (
    <div className="w-full bg-[#F3EEE8] border border-[#E6DED5] rounded-lg px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 gap-4">
      {/* Left Section */}
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          className="flex items-center gap-2 bg-[#F3EEE8] border border-[#E2D8CF] text-[#7A6F66] text-sm px-4 py-2 rounded-md hover:bg-[#F5F1ED]"
