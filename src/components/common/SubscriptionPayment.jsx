    ...
    {/* Total Payment Section */}
        <div className="bg-amber-50 rounded-2xl p-5 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-[#3b1f12] mb-1">
                Total Payment
              </h2>
              <button className="text-xs text-[#3b1f12] hover:text-gray-900 ">
                View Details
              </button>
            </div>
            <div className="text-right">
              <p className="text-2xl font-semibold text-[#3b1f12]">$0.00</p>
              <button className="text-xs text-[#550000] hover:text-red-700 underline">
                View Details
              </button>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-b from-[#3b1f12] to-[#5c2f1b] text-white rounded-xl font-medium transition-colors">
