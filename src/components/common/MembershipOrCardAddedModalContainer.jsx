...
function MembershipOrCardAddedModalContainer() {
  ...
  return (
    <div>
      {cardListingModal && (
        <Dialog
          open={cardListingModal}
          onOpenChange={(open) => {
            if (isPlanMandatory && !open) return;
            setCardListingModal(false);
            ...
            <DialogContent className="relative w-[400px] rounded-2xl p-0 border-none overflow-visible bg-transparent z-50">
              ...
              >
                ...
                {(deleteCardMutation?.isPending ||
                  subcriptionDetailQuery?.isLoading ||
                  markDefaultCardMutation?.isPending) && (
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                ...
                                onClick={() =>
                                  deleteCardMutation.mutate(value?.id)
                                }
                                variant="secondary"
                              >
                                Continue
